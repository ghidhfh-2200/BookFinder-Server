...
export default function ReportOutdatedModal({ open, library, fields, onReport, onRevoke, onCancel }) {
  ...
  return (
    ...
    >
      <Alert
        ...
        message="选择信息已经过时的字段。同一字段被足够多人报告后会自动标记。"
      />
